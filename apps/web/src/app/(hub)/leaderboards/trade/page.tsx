...
/**
 * The Trade Barons board. A thin route on purpose — the tables, the member's own strip and the
 ...
 */
export const metadata = boardMetadata('trade');

export const dynamic = 'force-dynamic';

export default function TradeBaronsPage({
  searchParams,
}: {
  ...
  return (
    <>
      <PageHeader {...boardHeaderProps('trade')} />
      <LeaderboardBoardBody boardKey="trade" searchParams={searchParams} />
    </>
  );
}
