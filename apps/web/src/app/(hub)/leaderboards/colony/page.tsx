...
/**
 * The Colony Builders board. A thin route on purpose — the tables, the member's own strip and
 * the tier ladder all live in `board-page.tsx`, shared with the other two boards, and this file
 ...
 */
export const metadata = boardMetadata('colony');

export const dynamic = 'force-dynamic';

export default function ColonyBuildersPage({
  searchParams,
}: {
  ...
  return (
    <>
      <PageHeader {...boardHeaderProps('colony')} />
      <LeaderboardBoardBody boardKey="colony" searchParams={searchParams} />
    </>
  );
}
