...
@Module({
  imports: [DatabaseModule, AuthzModule, AuthModule, MembersModule, CmdrModule, AdminModule, PublicModule, LogisticsModule, TelemetryModule, MediaModule, CompanionModule, LiveModule, AiModule, ForumModule],
